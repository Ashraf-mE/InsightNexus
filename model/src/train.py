...
if __name__ == '__main__':
    ...
    data_dir = r"C:\Users\ramas\Downloads\dataverse_files\Aug2.0"
    dataset = SkinCancer(data_dir, 'C:/Users/ramas/Downloads/Dermoscopic-image-classification-main/my-data/csv/train.csv', transform=None)
    dataset_size = len(dataset)
    test_dataset = SkinCancer(data_dir,'C:/Users/ramas/Downloads/Dermoscopic-image-classification-main/my-data/csv/test.csv', transform=None)
    ...
    for fold, (train_idx, val_idx) in enumerate(splits.split(np.arange(len(dataset)))):
        ...
        np.save(f'C:/Users/ramas/Downloads/Dermoscopic-image-classification-main/my-results/{model._get_name()}_{args.modality}_{args.finetune}_Fold{fold}.npy', cf_matrix)  # noqa: E501
